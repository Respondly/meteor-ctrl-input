...
// APP CUSTOMIZATIONS
PKG.Quill = Quill; // Make sure quill is available to the package

// Note: Removed .ql-container{box-sizing:border-box;cursor:text;font-family:Helvetica,Arial,sans-serif;font-size:13px;height:100%;line-height:1.42;margin:0;overflow-x:hidden;overflow-y:auto;padding:12px 15px;position:relative}
// from the section below to remove default styling from the quill container
